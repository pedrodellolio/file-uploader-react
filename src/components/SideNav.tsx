...
function SideNav(props: SideNavProps) {
  return (
    <nav className="border-r border-blue-800 h-screen w-[250px] text-blue-200 bg-blue-800 py-8 px-4">
      <div>
...
function FolderItem(props: FolderItemProps) {
  ...
  return (
    <>
      ...
      >
        {hasSubFolders ? (
          <a className="cursor-pointer material-symbols-rounded text-blue-100 text-xl">
